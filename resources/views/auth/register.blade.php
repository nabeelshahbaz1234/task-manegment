						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" autocomplete="off" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
									...
									<input id="confirmed_password" type="password" class="form-control" name="confirmed_password" required data-eye placeholder="Enter confirm password">
								   ...
								   <div class="form-group">
									...
									<option value="" slected>Select Role type</option>
