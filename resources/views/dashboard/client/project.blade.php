...
<div class="row">
    {{-- @dd(Auth::user()->clienT_Projects) --}}
@foreach (Auth::user()->clienT_Projects as $project)
  <div class="col-md-3">
        ...
        <div class="card-header d-flex justify-content-between align-items-center pt-0 pr-3 pb-3 pl-3">
            <div class="d-flex">
                ...
                <a href="{{route('client.detail_projects',$project->id)}}"><h4
        ...
        <div class="card-body pt-0 pl-3 pb-0">
            <div>
                ...
                <span class="float-right projectStatistics">
                                            <b></b>
              {{$project->tasks->where('status',0)->count() > 0}}
