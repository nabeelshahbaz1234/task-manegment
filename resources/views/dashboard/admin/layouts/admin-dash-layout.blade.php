...
<head>
  ...
  <!-- Font Awesome Icons -->
 <link rel="stylesheet" href="{{ asset('plugins/Theme/ijaboCropTool.min.css')}}">
  <!-- Theme style -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('admin.add_project')}}" class="nav-link active">
                  <i class="far fa-folder-open"></i>
                  <p>Project Add</p>
                </a>
              <li class="nav-item">
                <a href="{{route('admin.edit_project')}}" class="nav-link">
                  <i class="far fa-folder-open"></i>
                  <p>Project Edit</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('admin.detail_project')}}" class="nav-link">
                  <i class="far fa-folder-open"></i>
                  <p>Project Detail</p>
                </a>
...
botton.addEventListener('click', function (e) {
  ...
  function changeImage(){
    // alert(true)
    var a = document.getElementById("admin_image");
    alert(a.value)
    document.getElementById("admin_image").click();
    // $('#admin_image').click();
  }
  ...
  $(function(){
    ...
    // $(document).on('#change_picture_btn', function(){
    //   alert(true)
    //   $('#admin_image').click();
    // });
